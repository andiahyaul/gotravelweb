    ...
    <div class="swiper-container">
        <div>
            ...
            <section class="islands">
                <img
                    src="{{ asset('frontend/assets/img/bromo.jpg') }}"
                    alt=""
                    class="islands__bg"
                />
...
>
    <div class="logos__container container grid">
        ...
        <div class="logos__img">
            <img src="{{ asset('frontend/assets/img/traveloka.png') }}" alt="" />
        </div>
        <div class="logos__img">
            <img src="{{ asset('frontend/assets/img/wonderfull.png') }}" alt="" />
        </div>
        <div class="logos__img">
            <img src="{{ asset('frontend/assets/img/tiket.png') }}" alt="" />
        </div>
    </div>
</section>
    ...
    <div class="value__container container grid">
        <div class="value__images">
            ...
            <div class="value__img">
                <img src="{{ asset('frontend/assets/img/serpis.png') }}" alt="" />
            </div>
        </div>
